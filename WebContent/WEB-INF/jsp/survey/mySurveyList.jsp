...
<div class="container">
	...
	<hr>
	<s:if test="mySurveys.isEmpty() == true"><center>目前您没有任何调查项!</center></s:if >
	<s:else>
	...
	<nav>
	  <ul class="pagination">
	  	<s:if test="%{pageNow > 1}">
	    <li>
	      <s:a action="SurveyAction_mySurveys" namespace="/" aria-label="Previous">
		...
		<li>
			<s:a action="SurveyAction_mySurveys" namespace="/"  onclick="pageselectCallback">
	    ...
	    <li>
	      <s:a action="SurveyAction_mySurveys" namespace="/" aria-label="Next">
	      		<s:set var="pageNow" value="pageNow" />
			 	<s:param name="pageNow"> <s:property value="#pageNow+1"/></s:param>
			 	<s:param name="survey_name"><s:property value="#survey_name"/></s:param>  
