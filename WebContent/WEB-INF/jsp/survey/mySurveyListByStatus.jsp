...
<div class="container">
					...
					<div class="col-md-4">
						<s:form action="SurveyAction_searchSurveyByStatus" method="post">
							<select class="form-control" name="survey_status" onchange="this.form.submit();" >
		  						...
		  						<s:property value="#survey_status"/>
	...
	<hr>
	<s:if test="mySurveys.isEmpty() == true"><center>没有此类调查问卷！</center></s:if >
	<s:else>
	...
	<s:if test="%{#totalPage>1}">
		<nav>
			<ul class="pagination">
				<s:if test="%{pageNow > 1}">
				<li>
					<s:a action="SurveyAction_searchSurveyByStatus" namespace="/" aria-label="Previous">
						<s:set var="pageNow" value="pageNow" />
						<s:param name="pageNow"> <s:property value="#pageNow-1"/></s:param> 
						<s:param name="survey_status"> <s:property value="#survey_status"/></s:param> 
				...
				<li>
					<s:a action="SurveyAction_searchSurveyByStatus" namespace="/">
				...
				<li>
					<s:a action="SurveyAction_searchSurveyByStatus" namespace="/" aria-label="Next">
						<s:set var="pageNow" value="pageNow" />
						<s:param name="pageNow"> <s:property value="#pageNow+1"/></s:param> 
						<s:param name="survey_status"> <s:property value="#survey_status"/></s:param> 
