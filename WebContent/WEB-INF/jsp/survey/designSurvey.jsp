									...
									<table>
										<tr>
											...
											<td class="tdPHeaderR">
												...
												<s:a namespace="/" action="PageAction_deletePage?sid=%{#sId}&pid=%{#pId}" id="delete">删除页</s:a>&nbsp;
											</td>
										</tr>
									</table>
								</td>
...
<hr>
<div><center><s:a action="SurveyAction_mySurveys" namespace="/" class="btn btn-info" role="button">设计完成</s:a></center></div>
</div>	
</body>
</html>