...
<div class="container">
			...
			<tbody>
				<s:iterator value="surveys">
					...
					<tr>
						...
						<td>
							<s:a action="#" namespace="/" cssClass="aList">查看</s:a>
						</td>
						<td>
	...
	<s:if test="%{#totalPage>1}">
		<nav>
		  ...
		  <s:if test="%{pageNow > 1}">
			    <li>
			      <s:a action="ManagerAction_findAllSurveysByTitle" namespace="/" aria-label="Previous">
		    ...
		    <s:iterator value="pageList" var="pageNum">
				<li><s:a action="ManagerAction_findAllSurveysByTitle" namespace="/">
			...
			<s:if test="%{totalPage > pageNow}">	
			    <li>
			      <s:a action="ManagerAction_findAllSurveysByTitle" namespace="/" aria-label="Next">
			      			<s:set var="pageNow" value="pageNow" />
					 		<s:param name="pageNow"> <s:property value="#pageNow+1"/></s:param> 
