				   	...
				   	<div class="col-md-5">
						<s:form action="EngageSurveyAction_findAllAvailableSurveysByTitle" namespace="/" method="post" validate="true" >
							<div class="input-group">
								...
								<input type="text" name="survey_name" <s:if test="%{#survey_name!=null}">value="<s:property value="#survey_name"/>"</s:if> class="form-control" placeholder="Search for...">				      					 <span class="input-group-btn">
		...
		<s:set var="survey_name" value="survey_name" />
	  	<ul class="pagination">
	    	...
	    	<s:iterator value="pageList" var="pageNum">
				<li>
					<s:a action="EngageSurveyAction_findAllAvailableSurveys" namespace="/">
